# Canvas_CodePath
# Lab 7 - *Canvas_CodePathe*

**Canvas_CodePath** is an app that allows users to use gestures in order to create fun pictures using a variety of images.
...
<img src='https://i.imgur.com/XHZN9ZI.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
